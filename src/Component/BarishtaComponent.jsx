...
const BarishtaComponent = () => {
  return (
    <div className='p-5 bg-[#edebe9] w-100 mt-14 lg:pl-20 lg:pr-20 pb-10 relative'>
<div className='pt-5 flex justify-between'> 
    <span className='text-[#le3932] font-bold text-2xl'> Barista Recommends</span>
    ...
    >
      <SwiperSlide>
        ...
        <div className='grid grid-cols-[1fr_3fr]'>
            <div>
            <img src="https://www.starbucks.in/assets/icon/placeholder.webp" alt="java chip" className='rounded-lg h-20 object-cover width={80}' />
            </div> 
            <div className='p-2'>
        ...
        <p className='text-semibold'>Cappuccino</p>
        <p className='text-xs text-[#6c757d]'> SHORT() </p>
                </div>
            </div>
            
            <div className='mt-5 flex justify-between'>
               <div> <span className='font-semibold text-sm' > ₹ 283</span></div>
               <div> <button className='border-2 p-2 w-32 rounded-3xl text-white bg-[#00754a]'> Add item </button></div>
            </div>
        </div></SwiperSlide>
      <SwiperSlide> <div className='w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer '> 
        <div className='grid grid-cols-[1fr_3fr]'>
            <div>
            <img src="https://starbucksstatic.cognizantorderserv.com/Items/Small/webP/100447.webp" alt="java chip" className='rounded-lg h-20 object-cover width={80}' />
            </div> 
            <div className='p-2'>
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="0.5" y="0.5" width="15" height="15" rx="1.5" stroke="#00754A"/>
        ...
        <p className='text-semibold'>Signature Hot Chocolate </p>
        <p className='text-xs text-[#6c757d]'>  SHORT(237 ML)  </p>
                </div>
            </div>
            
            <div className='mt-5 flex justify-between'>
               <div> <span className='font-semibold text-sm' > ₹ 294.50</span></div>
               <div> <button className='border-2 p-2 w-32 rounded-3xl text-white bg-[#00754a]'> Add item </button></div>
            </div>
        </div></SwiperSlide>
      <SwiperSlide> <div className='w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer '> 
        <div className='grid grid-cols-[1fr_3fr]'>
            <div>
            <img src="https://starbucksstatic.cognizantorderserv.com/Items/Small/webP/112573.webp" alt="java chip" className='rounded-lg h-20 object-cover width={80}' />
            </div> 
            <div className='p-2'>
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="0.5" y="0.5" width="15" height="15" rx="1.5" stroke="#00754A"/>
        ...
        <p className='text-semibold'>Vanilla Milkshake </p>
        <p className='text-xs text-[#6c757d]'>  TALL(354 ML)  </p>
                </div>
            </div>
      ...
      <SwiperSlide> <div className='w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer '> 
        <div className='grid grid-cols-[1fr_3fr]'>
            <div>
            <img src="https://starbucksstatic.cognizantorderserv.com/Items/Small/webP/104997.webp" alt="java chip" className='rounded-lg h-20 object-cover width={80}' />
            </div> 
            <div className='p-2'>
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="0.5" y="0.5" width="15" height="15" rx="1.5" stroke="#00754A"/>
        ...
        <p className='text-semibold'>Cold Brew Black </p>
        <p className='text-xs text-[#6c757d]'>  SHORT(Short Cold Brew Black)  </p>
                </div>
            </div>
            
            <div className='mt-5 flex justify-between'>
               <div> <span className='font-semibold text-sm' > ₹ 299</span></div>
               <div> <button className='border-2 p-2 w-32 rounded-3xl text-white bg-[#00754a]'> Add item </button></div>
            </div>
        </div></SwiperSlide>
      ...
...
export default BarishtaComponent